...
include('config.php');
include('session.php');
$uyedetay=$uyesinif->uyedetay($session_id);
?>
<!DOCTYPE html>
<html>
<head>
...
alert("Yönetim İşlemlerine Yönlendiriliyorsunuz...  "); 
...
alert("Rezervasyon İşlemlerine Yönlendiriliyorsunuz...  "); 
  ...
  <div class="tm-main-content" id="top">
            ...
            <div class="container py-2">
              <a href="#"  class="navbar-brand">Otel Rezervasyonu</a>
              <button type="button" class="navbar-toggler" data-toggle="collapse" date-target="#navbar-comu" aria-controls="navbar-comu">
            	...
            	<div class="collapse navbar-collapse" id="navbar-comu">
                  ...
                  <li class="nav-item px-3">
                    <a href="#" class="nav-link text-white"><i class="fa fa-group"> Aktif Kullanıcı : <?php echo $uyedetay->adsoyad; ?></i></a>
  				  </li>

                    <li class="nav-item px-3">
                    <a href="yonetim/ayarlar.php" class="nav-link text-white"><i class="fa fa-address-book" onclick="yonetim()" > Yönetim İşlemleri</i></a>
  				  </li>
				  
				 <li class="nav-item px-3">
                    <a href="pdo/rezervasyonkontrol.php" class="nav-link text-white"><i class="fa fa-shopping-cart" onclick="rez()"> Rezervasyonlarım</i></a>
  				  </li>

                  <li class="nav-item px-3 text-white ">
                    <a href="<?php echo BASE_URL; ?>cikis.php"  class="nav-link text-white" onclick="cikis()">Çıkış Yap <i class="fa fa-sign-out"> </i></a>
  				  </li>
            		</ul>
            	</div>
            </nav>
                            ...
                            <div class="col-xs-12 ml-auto mr-auto ie-container-width-fix">
                                <form action="index.php" method="get" class="tm-search-form tm-section-pad-2">
                                    <div class="form-row tm-search-form-row">
                                        ...
                                        <a href="odalar.php" class="btn btn-primary ">Rezervasyon Ara</a>
                                        </div>
                                   </div>
                                </form>
                            </div>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <h2 class="tm-section-title">Tatil İçin Doğru Yerdesin</h2><br>
                              <a href="odalar.php" class="tm-color-white tm-btn-white-bordered">Hemen Rezervasyon Yapın</a>
                        </div>
                    </div>
                </div>
            </div>
